...
<!-- CLCdesq Integration -->
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_audiotracklisting_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_bookforeword_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-list"></span></span>
						<?php echo form_dropdown('clcdesq_bookindex_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-menu-hamburger"></span></span>
						<?php echo form_dropdown('clcdesq_booksamplechapter_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_category_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_location_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-globe"></span></span>
						<?php echo form_dropdown('clcdesq_language_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_numberofdiscs_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_series_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_showonwebsite_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_stockonorder_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						...
						<?php echo form_dropdown('clcdesq_upc_id',
							$clcdesq['available_attributes'],
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<div class="input-group">
						<span class="input-group-addon input-sm"><span class="glyphicon glyphicon-barcode"></span></span>
						<?php echo form_dropdown('clcdesq_uniqueid_id',
							$clcdesq['available_attributes'],
