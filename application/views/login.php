...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->config->item('application_version')  . ' | ' .  $this->lang->line('login_login'); ?></title>
...
<body>
	<div id="logo" align="center"><img height="90" width="90" src="<?php echo base_url();?>images/logo.png"></div>
